...
```bash
git add .
git commit -m "Prepare release 0.0.10"
...
The tag format must match the project version exactly (e.g., `0.0.10`, `1.0.0`).
...
- Check that the version matches a published tag exactly (e.g., `0.0.10`)
